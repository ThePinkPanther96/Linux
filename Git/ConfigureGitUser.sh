...
# Append the new user's public key to the "git" user's authorized_keys file
cat "/home/$new_username/.ssh/id_rsa.pub" >> "/home/git/.ssh/authorized_keys"
echo "Added $new_username's public key to the 'git' user's authorized_keys file."
